...
description: Migrate Chrome extensions from Manifest V2 to Manifest V3. Covers service workers, declarativeNetRequest, API replacements, and CSP changes.
---

# Extension Migration Skill (MV2 → MV3)
